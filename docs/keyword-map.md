...
Objetivo: asignar cada intención de búsqueda a una URL concreta, evitando que varias páginas compitan por la misma keyword principal.

## Principal

| Intención | Keywords | URL Objetivo | Nota |
|---|---|---|---|
| Taxi principal en Calatayud | taxi Calatayud, taxi en Calatayud, taxista Calatayud, taxi oficial Calatayud | `/` | La home es la página principal para esta búsqueda. |
| Servicio local dentro de Calatayud | pedir taxi Calatayud, reservar taxi Calatayud, taxi ahora Calatayud | `/taxi-calatayud/` | Página de apoyo, centrada en recogidas locales y reserva. |
| Teléfono y contacto | teléfono taxi Calatayud, número taxi Calatayud, llamar taxi Calatayud | `/telefono-taxi-calatayud/` | Intención transaccional directa. |
| Taxi cerca de mí | taxi cerca de mí Calatayud, taxi cerca de mi en Calatayud | `/taxi-cerca-de-mi-calatayud/` | Usar con naturalidad, no repetir en exceso. |
...
| Intención | Keywords | URL Objetivo |
|---|---|---|
| Pueblos general | taxi comarca de Calatayud, taxi pueblos comarca Calatayud | `/taxi-pueblos-comarca-calatayud/` |
| Ateca | taxi Ateca Calatayud | `/taxi-ateca/` |
| Ariza | taxi Ariza Calatayud | `/taxi-ariza/` |
| Municipios sin página individual | Terrer, Maluenda, Munébrega, Ibdes, Miedes, Aniñón, Sabiñán, Morata de Jiloca, Tobed, Calmarza, Carenas | `/taxi-pueblos-comarca-calatayud/` con bloques útiles por zonas |
...
No crear ni ampliar páginas para estas búsquedas hasta confirmarlo con el propietario:

- taxi 24 horas Calatayud
- taxi empresas Calatayud
- taxi para mutuas Calatayud
- taxi aseguradoras Calatayud
- taxi mascotas Calatayud
- taxi con silla infantil Calatayud
- American Express
- atención real en todos los idiomas
