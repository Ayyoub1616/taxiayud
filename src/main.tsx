...
const regionHighlights: Record<LangCode, string[]> = {
  es: ["Calatayud", "A-2", "Balnearios", "Pueblos"],
  en: ["Calatayud", "A-2", "Spas", "Villages"],
  fr: ["Calatayud", "A-2", "Thermes", "Villages"],
  ca: ["Calatayud", "A-2", "Balnearis", "Pobles"],
  de: ["Calatayud", "A-2", "Thermalbäder", "Dörfer"],
  it: ["Calatayud", "A-2", "Terme", "Paesi"],
  pt: ["Calatayud", "A-2", "Termas", "Aldeias"],
  nl: ["Calatayud", "A-2", "Kuuroorden", "Dorpen"],
  ar: ["كالاتايود", "A-2", "المنتجعات", "القرى"],
};
